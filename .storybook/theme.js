...
export const CloudTheme = create({
    ...
    brandUrl: 'https://github.com/yandex-cloud/react-data-table',
    brandTitle: `<div style="font-size: 18px; color: #027bf3; font-weight: 600; margin-top: -6px; margin-bottom: 2px;">React Data Table</div>
