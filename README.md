...
| maxIndex                                    | `Number`                                   |                       | Optional maximum index value used to calculate the width of the index column. If not provided, the actual last index (startIndex + data.length + 1) is used                                                                                                                                                                         |
